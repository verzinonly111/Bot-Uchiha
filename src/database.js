...
class DatabaseManager {
    ...
    async addUser(userData) {
        ...
        try {
            const result = await this.connection.query('INSERT INTO users SET ?', userData);
            return result;
        } catch (error) {
    ...
    async addTransaction(transactionData) {
        ...
        try {
            const result = await this.connection.query('INSERT INTO transactions SET ?', transactionData);
            return result;
        } catch (error) {
    ...
    async getTransactions(userId) {
        ...
        try {
            const result = await this.connection.query('SELECT * FROM transactions WHERE user_id = ?', [userId]);
            return result;
        } catch (error) {
